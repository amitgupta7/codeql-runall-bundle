...
var TypeTable = (function () {
    ...
    TypeTable.prototype.getTypeString = function (type, unfoldAlias) {
        ...
        if (isTypeReference(type) && (type.target.objectFlags & ts.ObjectFlags.Tuple)) {
            ...
            var prefix = "tuple;".concat(minLength, ";").concat(restIndex);
    ...
    TypeTable.prototype.tryGetTypeOfSymbol = function (symbol) {
        try {
            ...
            console.warn("Could not compute type of '".concat(this.typeChecker.symbolToString(symbol), "'"));
            return null;
        }
    };
    ...
    TypeTable.prototype.getSignatureString = function (kind, signature) {
        ...
        var tag = "".concat(kind, ";").concat(isAbstract ? "t" : "f", ";").concat(numberOfTypeParameters, ";").concat(requiredParameters, ";").concat(restParameterTag, ";").concat(returnTypeId);
